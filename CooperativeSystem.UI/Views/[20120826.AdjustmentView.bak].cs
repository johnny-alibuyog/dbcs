...
namespace CooperativeSystem.UI.Views
{
    public partial class AdjustmentView : FormTemplate, IAdjustmentView, IServicesAdapter
    {
        ...
        public void PopulateReceiptPulldown(IList<CashReceiptLookupModel> cashReceiptsLookup)
        {
            _receiptNumberComboBox.DataSource = cashReceiptsLookup;
            _receiptNumberComboBox.ValueMember = "ReceiptID";
            _receiptNumberComboBox.DisplayMember = "OfficialReceiptNumber";
        }

        public void LoadReceipt()
        {
            var item = _receiptNumberComboBox.SelectedItem as CashReceiptLookupModel;
            if (item != null)
                _presenter.LoadReceipt(item.ReceiptID);
        }
        ...
        {
            get { return _collegeInsurancePlanChangeButton.Enabled; }
            set { _collegeInsurancePlanChangeButton.Enabled = value; }
        }
        ...
        private void DisableFields()
        {
            ...
            _receiptNumberComboBox.Enabled = false;
        ...
        private void CollegeInsurancePlanChangeButton_Click(object sender, EventArgs e)
        {
            ...
            _childCIPAdjustmentView.ReceiptID = item.ReceiptID;
