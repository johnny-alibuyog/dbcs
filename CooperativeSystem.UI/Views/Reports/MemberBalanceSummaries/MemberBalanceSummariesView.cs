...
{
    public partial class MemberBalanceSummariesView : FormTemplate, IMemberBalanceSummariesView
    {
        private MemberBalanceSummariesPresenter _presenter;

        public MemberBalanceSummariesView()
        {
            InitializeComponent();

            _presenter = new MemberBalanceSummariesPresenter(this);
            _presenter.Error += new ErrorHandler(NotifyError);
            _presenter.Success += new SuccessHandler(NotifyInformation);
        }

        #region IMemberBalanceSummariesView Members
        ...
        public void PopulateMemberLookup(List<MemberLookupModel> members)
        {
        ...
        public void PopulateReports(IList<MemberBalanceSummaryItem> balanceSummaries, string membershipCategory)
        {
            try
            {
                using (var mbsrv = new MemberBalanceSummariesReportView())
                {
                    mbsrv.Date = DateTime.Today;
                    mbsrv.MembershipCategory = membershipCategory;
                    mbsrv.BalanceSummaries = balanceSummaries;
        ...
        private void MemberBalanceSummariesView_Shown(object sender, EventArgs e)
        {
