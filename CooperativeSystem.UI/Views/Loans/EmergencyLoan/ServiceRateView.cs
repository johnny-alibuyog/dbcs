...
using CooperativeSystem.Service.Presenters.Loans.EmergencyLoan;
using CooperativeSystem.UI.Views.Utilities.ControlValidation;

namespace CooperativeSystem.UI.Views.Loans.EmergencyLoan
{
    public partial class ServiceRateView : ServiceRateFormTemplate, IServiceRateView
    {
        private readonly ServiceRatePreseter _presenter;
