...
{
    public partial class CapitalShareWithdrawalAssessmentView : FormTemplate, ICapitalShareWithdrawalAssessmentView
    {
        private CapitalShareWithdrawalAssessmentPresenter _presenter;

        public CapitalShareWithdrawalAssessmentView()
        {
            InitializeComponent();

            _presenter = new CapitalShareWithdrawalAssessmentPresenter(this);
        ...
        #region ICapitalShareWithdrawalAssessmentView Members
        ...
        private void CapitalShareWithdrawalAssessmentView_Shown(object sender, EventArgs e)
        {
