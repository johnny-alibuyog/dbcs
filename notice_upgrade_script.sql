/*
   Monday, August 12, 20131:54:07 PM
   User: 
   Server: extreme
   Database: csdb_prod
   Application: 
...
/*
   Monday, August 12, 20132:09:26 PM
   User: 
   Server: extreme
   Database: csdb_prod
   Application: 
...
GO
CREATE TABLE Loans.LoanNotices
	(
	LoanNoticeID bigint NOT NULL IDENTITY (1, 1),
	LoanID bigint NOT NULL,
	PreviousIssueDate smalldatetime NULL,
	IssueDate smalldatetime NULL,
	IssueAddress nvarchar(350) NULL,
	IssueTo nvarchar(150) NULL,
...
GO
ALTER TABLE Loans.LoanNotices ADD CONSTRAINT
	PK_LoanNotices PRIMARY KEY CLUSTERED 
	(
	LoanNoticeID
...
GO
ALTER TABLE Loans.LoanNotices ADD CONSTRAINT
	FK_LoanNotices_Loans FOREIGN KEY
	(
	LoanID
	) REFERENCES Loans.Loans
	(
	LoanID
	) ON UPDATE  NO ACTION 
	 ON DELETE  NO ACTION 
...
GO
ALTER TABLE Loans.LoanNotices SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
select Has_Perms_By_Name(N'Loans.LoanNotices', 'Object', 'ALTER') as ALT_Per, Has_Perms_By_Name(N'Loans.LoanNotices', 'Object', 'VIEW DEFINITION') as View_def_Per, Has_Perms_By_Name(N'Loans.LoanNotices', 'Object', 'CONTROL') as Contr_Per 
...
BEGIN TRANSACTION
GO
ALTER TABLE Member.Members SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
...
GO
CREATE TABLE Member.EducationalAttainments
	(
...
ALTER TABLE Member.EducationalAttainments ADD CONSTRAINT
	PK_EducationalAttainments PRIMARY KEY CLUSTERED 
	(
	MemberID,
	LineNumber
	) WITH( STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
GO
COMMIT
select Has_Perms_By_Name(N'Member.EducationalAttainments', 'Object', 'ALTER') as ALT_Per, Has_Perms_By_Name(N'Member.EducationalAttainments', 'Object', 'VIEW DEFINITION') as View_def_Per, Has_Perms_By_Name(N'Member.EducationalAttainments', 'Object', 'CONTROL') as Contr_Per 
...
IF EXISTS(SELECT * FROM Member.Members)
	 EXEC('INSERT INTO Member.Tmp_Members (MemberID, AccountNumber, AccountStatusID, MembershipCategoryID, ApplicationDate, WithdrawalDate, LastName, FirstName, MiddleName, DateOfBirth, PlaceOfBirth, MaritalStatusID, SexTypeID, Address, HomePhone, MobilePhone, Occupation, Employer, MonthlySalary, OfficeAddress, OfficePhone, SpouseLastName, SpouseFirstName, SpouseMiddleName, SpouseOccupation, SpouseContactNumber, NearestRelativeLastName, NearestRelativeFirstName, NearestRelativeMiddleName, NearestRelativeContactNumber)
		SELECT MemberID, AccountNumber, AccountStatusID, MembershipCategoryID, ApplicationDate, WithdrawalDate, LastName, FirstName, MiddleName, DateOfBirth, PlaceOfBirth, MaritalStatusID, SexTypeID, Address, HomePhone, MobilePhone, Occupation, Employer, MonthlySalary, OfficeAddress, OfficePhone, SpouseLastName, SpouseFirstName, SpouseMiddleName, SpouseOccupation, SpouseContactNumber, NearestRelativeLastName, NearestRelativeFirstName, NearestRelativeMiddleName, NearestRelativeContactNumber FROM Member.Members WITH (HOLDLOCK TABLOCKX)')
GO
...
GO
COMMIT
select Has_Perms_By_Name(N'Savings.TimeDeposits', 'Object', 'ALTER') as ALT_Per, Has_Perms_By_Name(N'Savings.TimeDeposits', 'Object', 'VIEW DEFINITION') as View_def_Per, Has_Perms_By_Name(N'Savings.TimeDeposits', 'Object', 'CONTROL') as Contr_Per BEGIN TRANSACTION
GO
...
GO
COMMIT
select Has_Perms_By_Name(N'Savings.DividendComputations', 'Object', 'ALTER') as ALT_Per, Has_Perms_By_Name(N'Savings.DividendComputations', 'Object', 'VIEW DEFINITION') as View_def_Per, Has_Perms_By_Name(N'Savings.DividendComputations', 'Object', 'CONTROL') as Contr_Per 