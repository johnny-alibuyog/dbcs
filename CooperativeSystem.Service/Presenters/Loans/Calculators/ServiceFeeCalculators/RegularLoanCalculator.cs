...
{
    internal class RegularLoanCalculator : ServiceFeeCalculatorTemplate
    {
        ...
        internal override ServiceFees ComputeServiceFees(string paymentModeID, string loanDeductionTypeID, decimal loanAmount, int terms, ref decimal interestRate)
        {
            ...
            var differedAmount = loanAmount - Member.CapitalShare.CurrentBalance;
            ...
            var fees = new ServiceFees()
            {
                ...
                LoanGuaranteeFund = (differedAmount > 0) ? differedAmount * (loanGuaranteeFundRate / 100) : 0M,
